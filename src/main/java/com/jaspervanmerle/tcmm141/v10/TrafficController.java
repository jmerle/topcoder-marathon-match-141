package com.jaspervanmerle.tcmm141.v10;
...
public class TrafficController {
    ...
    public Set<Cell> getLightsToSwitch() {
        ...
        outer:
        for (Car car : cars) {
            Set<Cell> lightsToSwitchCar = new HashSet<>();

            Road road = car.road;
            int gapsSeen = 0;

            for (int i = road.cells.indexOf(car.cell) + 1; i < road.cells.size(); i++) {
                Cell cell = road.cells.get(i);
                ...
                lightsToSwitchCar.add(cell);
            }

            lightsToSwitch.addAll(lightsToSwitchCar);
        }
